...
import com.example.javamaps.model.PlaceDatabase;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,GoogleMap.OnMapLongClickListener{
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //37.9604538,41.8503269

       /* LatLng siirt = new LatLng(37.9604538,41.8503269);
        mMap.addMarker(new MarkerOptions().position(siirt).title("Siirt Üniversitesi"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(siirt,15));
